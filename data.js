...
const en = [
  ...
  },
  {
    ...
    question: "Pick all the correct answers: 'He .... with the game.'",
    type: "checkbox",
  },
  {
    answers: [
    ...
    question: "Pick all the correct answers: 'They .... with their complaining.'",
    type: "checkbox",
  },
  {
    answers: [
  ...
  {
    answers: [
      {correct: false, answer: "angries with"},
      {correct: false, answer: "is angry at"},
      {correct: true, answer: "is angry with"},
      {correct: false, answer: "angries at"},
    ],
    question: "She ... him.",
    type: "radio",
  },
  {
    ...
    question: "Pick all the correct answers: 'How ... does it take you to get to work?'",
    type: "checkbox",
  },
  {
    answers: [
  ...
  {
    answers: [
      {correct: false, answer: "What is he doing when the phone rings?"},
      {correct: false, answer: "What he was doing when the phone rang?"},
      {correct: false, answer: "What did he do when the phone was ringing?"},
      {correct: true, answer: "What was he doing when the phone rang?"},
    ],
    question: "Translate to English: 'Что он делал, когда зазвонил телефон?'",
    type: "radio",
  },
  {
    answers: [
  ...
  },
  {
    ...
    question: "Pick all the correct answers: 'When I .... around the park, I .... my friends.'",
    type: "checkbox",
  },
  {
    answers: [
