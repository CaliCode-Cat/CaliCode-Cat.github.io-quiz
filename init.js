...
(function () {
  ...
  */
  ...
  const Question  = function (dataEl) {
    ...
    this.answers = window.utils.shuffleArray(dataEl.answers);
  ...
  Questions.prototype.getQuestion = function (dataEl) {
    ...
    console.log(this.actualQn.answers);
  };
  ...
  window.initQuestions = function (langData) {
    ...
    qns.data = langData; // window.utils.shuffleArray(langData); //for processed data
